========================================================================
    KONSOLENANWENDUNG: ParallelMatrixMultiply-Projektübersicht
========================================================================

Diese ParallelMatrixMultiply-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ParallelMatrixMultiply-Anwendung besteht.


ParallelMatrixMultiply.vcxproj
...
ParallelMatrixMultiply.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ParallelMatrixMultiply.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
